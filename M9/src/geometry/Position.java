...
public class Position implements java.io.Serializable{
    ...
    static public Position barycenter(Collection<Position> positions) throws IllegalArgumentException{
        if(positions == null){
        ...
        return new Position(moyenneX/positions.size(),moyenneY/positions.size());
    }
}
