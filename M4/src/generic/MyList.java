...
public class MyList<E> {
	...
	/** Cell holding the first E in the list, or null */
	Cell first;
	 ...
	 * 
	 * A call to <code>new MyList(3, 2, 1)</code> will create a [ 3.0,
	 * 2.0, 1.0 ] list.
	 * 
	 * @param values
	 *            Values of the list
	...
	public void insertElement(int index, E value) {
		...
		if (index == 0) {
			...
			traveler.next = new Cell(value, traveler.next);
		}
		size++;
	}
